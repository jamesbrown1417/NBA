...
for match_id in all_match_ids:
    ...
    print(f"Progress: {len(all_team_stats)}/{len(all_match_ids)} - {round(len(all_team_stats)/len(all_match_ids)*100, 2)}%")
...
# # Save dataframe to csv
# all_team_stats_df.to_csv('Data/advanced_box_scores_2022-2023.csv', index=False)
...
# # Save dataframe to csv
# all_team_stats_df.to_csv('Data/advanced_box_scores_2021-2022.csv', index=False)