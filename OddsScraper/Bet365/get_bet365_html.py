...
async def collect_h2h_and_urls(driver):
    ...
    login_element = await driver.find_element(By.XPATH, "//div[contains(@class, 'hm-MainHeaderRHSLoggedOutWide_Login')] | //span[contains(@class, 'hrm-77') and contains(text(), 'Log In')]", timeout=10)
    await driver.sleep(2)
