...
# call_sgm_pointsbet(data = pointsbet_sgm, player_names = c("Jaylen Brown", "Jaylen Brown"), prop_line = c("24.5", "5.5"), prop_type = c("Player Points", "Player Rebounds"), over_under = c("Overs", "Overs"))
