...
opp_stats <- read_rds("../Data/stats_vs_opp.rds")

# Normalise rolling averages
opp_stats <-
opp_stats |> 
  mutate_at(vars(contains("rolling")), ~(. - mean(.)) / sd(.)) |> 
...
all_overs <-
  ...
  mutate(
    fixture_difficulty = case_when(
      market_name == "Player Points" ~ rolling_10_game_points,
      market_name == "Player Assists" ~ rolling_10_game_assists,
      market_name == "Player Rebounds" ~ rolling_10_game_rebounds,
      market_name == "Player Blocks" ~ rolling_10_game_blocks,
      market_name == "Player Steals" ~ rolling_10_game_steals,
      market_name == "Player Threes" ~ rolling_10_game_threes,
      market_name == "Player PRAs" ~ rolling_10_game_pras
    )
  )
...
overs_diff_method <-
  ...
  filter(rolling_10_game_points >= 1 & rolling_10_game_assists >= 1)
