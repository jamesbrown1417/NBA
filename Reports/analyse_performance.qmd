...
# Fix clippers name in opp stats
opp_stats <-
  opp_stats |>
...
unders_same_player_multi_method_1 <-
  ...
  left_join(point_unders,
            by = c("date", "match", "agency", "player_team", "player_name")) |>
...
unders_same_player_multi_method_3 <-
  ...
  ungroup() |> 
  filter(uncorrelated_price <= 4 & uncorrelated_price >= 2.85) |> 
  mutate(bet_won = if_else(assist_bet_won & point_bet_won, TRUE, FALSE)) |> 
  mutate(profit = if_else(bet_won, ((uncorrelated_price * 100) - 100), -100))
...
```{r}
# Overs Same Player Multi Method-----------------------------------------------
...
rebound_overs <- 
  ...
  select(
    ...
    rebound_diff_over_2023_24 = diff_over_2023_24,
    rebound_diff_over_last_10 = diff_over_last_10,
    rebound_bet_won = bet_won
  )
...
point_overs <- 
  ...
  select(
    ...
    point_diff_over_2023_24 = diff_over_2023_24,
    point_diff_over_last_10 = diff_over_last_10,
    point_bet_won = bet_won
  )
...
assist_overs <- 
  ...
  select(
    ...
    assist_diff_over_2023_24 = diff_over_2023_24,
    assist_diff_over_last_10 = diff_over_last_10,
    assist_bet_won = bet_won
  )
...
overs_same_player_multi_method_1 <-
  rebound_overs |>
  left_join(point_overs,
            by = c("date", "match", "agency", "player_team", "player_name")) |>
  filter(agency != "Unibet") |> 
  filter(
    rebound_diff_over_last_10 > 0.05 &
      point_diff_over_last_10 > 0.05 &
      rebound_diff_over_2023_24 > 0.05 &
      point_diff_over_2023_24 > 0.05
  ) |> 
  mutate(overall_diff_over_last_10 = (rebound_diff_over_last_10 * point_diff_over_last_10),
         overall_diff_over_2023_24 = (rebound_diff_over_2023_24 * point_diff_over_2023_24)) |> 
...
overs_same_player_multi_method_2 <-
    rebound_overs |>
  left_join(assist_overs,
            by = c("date", "match", "agency", "player_team", "player_name")) |>
  filter(agency != "Unibet") |> 
  filter(
    rebound_diff_over_last_10 > 0.05 &
      assist_diff_over_last_10 > 0.05 &
      rebound_diff_over_2023_24 > 0.05 &
      assist_diff_over_2023_24 > 0.05
  ) |> 
  mutate(overall_diff_over_last_10 = (rebound_diff_over_last_10 * assist_diff_over_last_10),
         overall_diff_over_2023_24 = (rebound_diff_over_2023_24 * assist_diff_over_2023_24)) |> 
  mutate(uncorrelated_price = (rebound_over_price * assist_over_price)) |> 
  arrange(date, match, player_name, player_team, desc(uncorrelated_price)) |> 
  group_by(date, match, player_name, player_team, assist_line, rebound_line) |>
  slice_head(n = 1) |> 
  ungroup() |> 
...
overs_same_player_multi_method_3 <-
  ...
  mutate(overall_diff_over_last_10 = (point_diff_over_last_10 * assist_diff_over_last_10),
         overall_diff_over_2023_24 = (point_diff_over_2023_24 * assist_diff_over_2023_24)) |> 
  mutate(uncorrelated_price = (point_over_price * assist_over_price)) |> 
  arrange(date, match, player_name, player_team, desc(uncorrelated_price)) |> 
  group_by(date, match, player_name, player_team, assist_line, point_line) |>
  slice_head(n = 1) |> 
  ungroup() |> 
...
overs_same_player_multi_method <-
  bind_rows(overs_same_player_multi_method_1,
            overs_same_player_multi_method_2,
            overs_same_player_multi_method_3)
