...
#| column: page
  ...
  datatable(options = list(pageLength = 15, autoWidth = TRUE, dom = 'Bfrtip'), class = 'cell-border stripe hover', rownames = FALSE)
```
...
# Function to create tabs with DT::datatable
make_dt_tabs <- function(match_list) {
  cat("::: panel-tabset\n")
  for (name in names(match_list)) {
    cat("\n### ", name, "\n\n")
...
make_dt_tabs(match_list_dabble)
```
...
if (length(match_list_betright) > 0) {
  make_dt_tabs(match_list_betright)
}
```
...
if(length(match_list_bet365) > 0) {
  make_dt_tabs(match_list_bet365)
}
```
:::
  ...
  <div class="arb-calculator">
    <div style="display: flex; justify-content: space-between; gap: 20px;">
      <div style="flex: 1; text-align: left;">
        <h3 style="color: var(--heading-color); text-align: left;">Odds</h3>
        <p><strong>Odds 1:</strong> ${formatNumber(odds1)}</p>
        <p><strong>Odds 2:</strong> ${formatNumber(odds2)}</p>
      </div>
      <div style="flex: 1; text-align: left;">
        <h3 style="color: var(--heading-color); text-align: left;">Stakes</h3>
    ...
    <h3 style="color: var(--link-color); text-align: center;">
